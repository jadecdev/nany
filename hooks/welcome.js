...
exports.welcome = function welcome(app) {
    ...
    He didn't 
    <voice gender="male" variant="1">want to work at all </voice></p> and he built <voice gender="female" variant="1">his house out of straw.</voice>
    ...
    <s><prosody volume="+6dB">The third little pig </prosody></s> 
    worked hard all day and built his house with bricks. 
        <p><s>The next day, a wolf happened to pass by the lane where the three little pigs lived;</s>
